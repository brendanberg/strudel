	...
	var result = {
		...
		parse: function(input, startRule) {
			...
			function parse_block() {
				...
				if (result0 !== null) {
					result0 = (function(offset) { return function() { return '@'; }; })(pos0);
				}
				if (result0 === null) {
					pos = pos0;
				}
				if (result0 === null) {
					...
					if (result0 === null) {
						...
						if (result0 === null) {
							...
							if (result0 !== null) {
								result0 = (function(offset, n, expr, body) {
										return function(context) {
							...
							if (result0 === null) {
								...
								if (result0 !== null) {
									result0 = (function(offset, n, expr, consequent, alternative) {
											return function(context) {
												return Strudel.blocks[n](context, expr, consequent, alternative);
											}
										})(pos0, result0[1], result0[3], result0[5], result0[7]);
								}
								if (result0 === null) {
									pos = pos0;
								}
			...
			function parse_expression() {
				...
				if (result0 !== null) {
					result0 = (function(offset, helper, p) {
							return function(ctx) {
			...
			function parse_literal() {
				...
				if (result0 !== null) {
					result0 = (function(offset, chars) { return function() { return chars.join(''); }; })(pos0, result0);
				}
				if (result0 === null) {
					pos = pos0;
				}
...
Strudel.escape = function(str) {
	// TODO: This needs to be cleaned up for Unicode, etc.
	return String(str)
		.replace(/&/g, '&amp;')
		.replace(/"/g, '&quot;')
		.replace(/'/g, '&#39;')
...
Strudel.blocks = {
	with: function(context, expr, body) {
		return body(expr(context));
	},
	each: function(context, expr, body) {
		var s = '';
	...
	if: function(context, expr, consequent, alternative) {
		if (expr(context)) {
	...
	unless: function(context, expr, consequent, alternative) {
		if (!expr(context)) {
			return consequent(context);
		} else if (alternative) {
			return alternative(context);
